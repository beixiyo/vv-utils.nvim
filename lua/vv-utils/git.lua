...
---@field old_len integer
---@field new_start integer
---@field new_len integer

---解析 unified diff hunk，用于在 index 与 worktree 之间映射行号
---@param diff string
---@return VVGitDiffHunk[]
...
---@class VVGitDiffLineSets
---@field staged table<integer, 'A'|'C'|'D'> HEAD 与 index 的差异，已映射到 worktree 行号
---@field unstaged table<integer, 'A'|'C'|'D'> index 与 worktree 的差异

---异步获取普通工作区文件的 staged / unstaged 双轨行级标记
---@param path string
---@param cb fun(sets: VVGitDiffLineSets?)
